...
import "./style.css";
import { digitalContentCreationAndSocialMediaManagement } from "./fstprices";
import { generateReadableName } from "../../utils/utilityFn";
import PricingCard, { PCardPropType } from "../../components/Cards/PricingCard";

const DigitalContentCreation = (): React.JSX.Element => {
  let cats = Object.keys(digitalContentCreationAndSocialMediaManagement);
  ...
  return (
    <div>
      ...
      <div className="container-fluid no-space">
        {Object.entries(digitalContentCreationAndSocialMediaManagement).map(
          (x, index) => {
            return;
            let [cat, details] = x;
