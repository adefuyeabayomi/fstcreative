...
import "./style.css";
import { videoEditsAndCreation } from "./fstprices";
import { generateReadableName } from "../../utils/utilityFn";
import PricingCard, { PCardPropType } from "../../components/Cards/PricingCard";

const VideoEditsAndCreation = (): React.JSX.Element => {
  let cats = Object.keys(videoEditsAndCreation);
  ...
  return (
    <div>
      ...
      <div className="container-fluid no-space">
        {Object.entries(videoEditsAndCreation).map((x, index) => {
          return;
          let [cat, details] = x;
...
export default VideoEditsAndCreation;
